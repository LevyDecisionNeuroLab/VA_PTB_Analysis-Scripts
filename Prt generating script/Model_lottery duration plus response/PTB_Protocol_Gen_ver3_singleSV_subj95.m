function PTB_Protocol_Gen_ver3_singleSV_subj95(subjectNum, gainsloss, tr, trialduration, DiscAcq, ParametricMod, path_in, path_out, PRT, par)
...
permissible_parameters = {'uniSV', 'uniCV'};
...
%   block_risk = [onsets(risk_index,1) offsets(risk_index,1)];
  ...
  if ~is_gains
    fprintf(fileID, '%13s\r\n%3s\r\n%4s %6s\r\n\r\n', 'gains_Display', '0', 'Color:', alt_colors{1});
    fprintf(fileID, '%14s\r\n%3s\r\n%4s %6s\r\n\r\n', 'gains_Display x p1', '0', 'Color:', '0 0 0');
  end
  ...
  if is_gains
    fprintf(fileID, '%9s\r\n%3s\r\n%4s %6s\r\n\r\n', 'loss_Display', '0', 'Color:', alt_colors{1});
    fprintf(fileID, '%14s\r\n%3s\r\n%4s %6s\r\n\r\n', 'loss_Display x p1', '0', 'Color:', '0 0 0');
  end
