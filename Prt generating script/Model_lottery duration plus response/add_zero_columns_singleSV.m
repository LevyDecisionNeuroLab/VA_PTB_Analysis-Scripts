%%  This script adds column of zeros to the SDM files with parametric modulator of subjective value.
...
clearvars
%% 
sdmwave = 'Sdm files_09100519';
predictorNums = 6; % the correct number of predictors
PredictorNames_new = {'gains_Display', 'gains_Display x p1', 'loss_Display', 'loss_Display x p1', 'Resp', 'Constant'};
